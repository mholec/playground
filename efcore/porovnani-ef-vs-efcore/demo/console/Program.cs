...
namespace demo_porovnani_ef_core_ef_6
{
    class Program
    {
        static void Main(string[] args)
        {
	        ...
	        using (var dbcontext = new Ef6DbContext(sqlString.ConnectionString))
	        {
				console.lib.ef6.OrderRepository repository = new console.lib.ef6.OrderRepository(dbcontext);
